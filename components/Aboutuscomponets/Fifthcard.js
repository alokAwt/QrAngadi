    ...
    <div className='flex flex-col justify-center items-center gap-12 mt-16'>
        <div className='flex md:flex-row-reverse mt-8 justify-center items-center flex-col md:gap-0 gap-8'>
            ...
            <h6 className="leading-5 font-bold text-2xl ">
              ...
              {`Our journey started within the dynamic ecosystem of Angadi World Technologies Pvt Ltd. Through innovation, dedication, and a commitment to excellence, we've evolved QR Angadi into a platform that reflects our core values: simplicity, functionality, and security.`}                </p>
            </div>
        </div>
