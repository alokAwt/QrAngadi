...
function HowItWorks() {
  ...
  return (
    <div className={`mb-20`}>
      ...
      <div
        className={`flex gap-10 w-[75%] mx-auto items-center my-10 flex-wrap`}
      >
        <Image
          src={bg}
          style={{
        ...
        {data.map((info, index) => {
          return (
            ...
            >
              <span
                className={`font-extrabold text-4xl absolute ms-auto bg-buttoncolor w-32 h-32 rounded-[50%] flex text-white left-[120px] top-[-50px]`}
              >
      ...
      <div className={`flex justify-center mt-20`}>
        <button
          className={`px-16 mx-auto py-3 border-none bg-buttoncolor font-semibold text-white`}
        >
          {` Let's get started`}
        </button>
      </div>
